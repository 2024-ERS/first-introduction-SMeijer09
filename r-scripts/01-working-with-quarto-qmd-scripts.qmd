...
-   rendered output can be in all kinds of formats, like docx, pdf,
    ...
    internet
-   a quarto document is easy to read even for a normal person 😊
...
A <- 5
# same for a variable B with value 10
B <- 10
# calculate the sum of A and B and call it C
C <- A+B
#print the results
print(C)
# calculate the mean of the numbers 2,8,12,5,3
my_numbers <- c(2,8,12,5,3)
?mean # check package 
