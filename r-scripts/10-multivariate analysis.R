...
SpecTotCover <- colSums(vegdat)
SpecTotCover
vegan::ordiplot(nmds_veg,display="sites",cex=1,type="t")
vegan::orditorp(nmds_veg,display="sp",priority=SpecTotCover,
...
vegan::ordisurf(dca,envdat$elevation_m,add=T,col="darkblue")

#add species contour
vegan::ordisurf(dca,vegdat$FestuRub,add=T,col="darkred")
...
#redo only with importantd uncorrelated variables
